...
class MainActivity : AppCompatActivity(), View.OnClickListener, DatePickerFragment.DialogDateListener, TimePickerFragment.DialogTimeListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_repeating_alarm.setOnClickListener(this)
    ...
    override fun onClick(v: View?) {
        when(v?.id){
            ...
            R.id.btn_set_repeating_alarm ->{
                ...
                val repeatTime = tv_repeating_alarm.text.toString()
    ...
    override fun onTimeDialogSet(tag: String?, hourOfDay: Int, minute: Int) {
        ...
        when(tag){
            ...
            TIME_PICKER_REPEAT_TAG -> tv_repeating_alarm.text = dateFormat.format(calendar.time)
            else -> {
